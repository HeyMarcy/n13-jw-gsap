...
import info from '../data/siteMetadata.js'
...
const Header: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    return (
        ...
        >
            <div>
                <h1
                    className="text-6xl font-thin  dark:text-slate-200 "

                >
                    <a href="/">Marcy <br />Montross</a>
                    {/* <a href="/">{info.author}</a> */}
                </h1>
                <h2
                    className="mt-3 uppercase tracking-wider text-sm font-semibold  dark:text-slate-200 "
                >
                    Software Engineer at Nerdery
                </h2>
                <p className="mt-4 max-w-xs text-xl leading-relaxed font-extralight tracking-wide ">
                    {info.aboutShort}
                </p>
                {children}
            </div>
