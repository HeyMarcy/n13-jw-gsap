...
const JobListing = ({ dateFrom = "2017", dateTo = "Present", url1 = "https://www.nerdery.com", title1 = "Software Engineer", title2, altLinks, employer = "Nerdery", technologies, achievements }: JobListingProps) => {
    return (
        <div
